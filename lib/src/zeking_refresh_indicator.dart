...
/// [ZekingRefreshIndicator] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [ZekingRefreshIndicator.onRefresh].
typedef ZekingRefreshCallback = Function();
...
/// always scrollable and, therefore, can trigger the [ZekingRefreshIndicator].
///
/// A [ZekingRefreshIndicator] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.io/design/platform-guidance/android-swipe-to-refresh.html>
///  * [ZekingRefreshIndicatorState], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [ZekingRefreshIndicator] to show
///    the inner circular progress spinner during refreshes.
///  * [CupertinoSliverRefreshControl], an iOS equivalent of the pull-to-refresh pattern.
///    Must be used as a sliver inside a [CustomScrollView] instead of wrapping
///    around a [ScrollView] because it's a part of the scrollable instead of
///    being overlaid on top of it.
class ZekingRefreshIndicator extends StatefulWidget {
  ...
  final ZekingRefreshCallback onRefresh;
  ...
  @override
  ZekingRefreshIndicatorState createState() => ZekingRefreshIndicatorState();
}

/// Contains the state for a [ZekingRefreshIndicator]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class ZekingRefreshIndicatorState extends State<ZekingRefreshIndicator> with TickerProviderStateMixin<ZekingRefreshIndicator> {
...
//          });
  ...
  ///
  /// Creating the [ZekingRefreshIndicator] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [ZekingRefreshIndicatorState].
  ///
  /// The future returned from this method completes when the
  /// [ZekingRefreshIndicator.onRefresh] callback's future completes.
  ///
